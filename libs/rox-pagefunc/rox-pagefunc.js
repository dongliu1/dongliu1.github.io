    ...
    Skpage.prototype={
        _init:function () {
            ...
            var _html=
                ...
                "   <a href='javascript:void(0)' type='start' class='rox-page-btn'><i class='fa fa-angle-double-left'></i></a>" +
                "   <a href='javascript:void(0)' type='prev' class='rox-page-btn'><i class='fa fa-angle-left'></i></a>" +
                "   <a href='javascript:void(0)' type='next' class='rox-page-btn'><i class='fa fa-angle-right'></i></a>" +
                "   <a href='javascript:void(0)' type='end' class='rox-page-btn'><i class='fa fa-angle-double-right'></i></a>" +
                "</div>" +
                "<div class='clear'></div>";
            $(_this).html(_html);
            this._bindClick();
