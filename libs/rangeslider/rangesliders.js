...
(function($, undefined){
	...
	$.widget("ui.dateRangeSliderHandle", $.ui.rangeSliderHandle, {
		...
		_createBoundsValues: function(){
			//console.log(JSON.stringify(this.options),new Date()+" row-2547");
			this._boundsValues = {
		...
		_bounds: function(){
			//console.log(JSON.stringify(this.options),new Date()+" row-2555");
		...
		_createSteps: function(){
			...
			var minDate = new Date(this.options.bounds.min.valueOf()),
				...
				i = 0,
				previous = new Date();
			//console.log(JSON.stringify(this.options),new Date()+" row-2570");
			this._steps = [];
			...
			//console.log(JSON.stringify(this.options),new Date()+" row-2571");
		...
		_addStep: function(result, factor, step){	
			...
			//console.log(JSON.stringify(this.options),new Date()+" row-2600");
			return result;
		},
		...
		_addThing: function(date, thing, factor, base){
			...
			//console.log(JSON.stringify(this.options),new Date()+" "+thing +" "+date["set" + thing]);
			return date;
		},
		...
		_round: function(value){
			...
			//console.log(JSON.stringify(this.options),new Date()+" row-2646");
			return after;
		},
		...
		update: function(){
			this._createBoundsValues();
			this._createSteps();
			//console.log(JSON.stringify(this.options),new Date()+" row-2653");
...
(function ($, undefined) {
	...
	$.widget("ui.dateRangeSlider", $.ui.rangeSlider, {
		...
		_mouseWheelScale: function(event, delta, deltaX, deltaY){	//rox
			//console.log(this);
            var container = this.element.parent();
			var left=(container.offset())?container.offset().left:container.offsetLeft;
			var width=(container.width())?container.width():container.offsetWidth;
			//var ratio=((event.pageX)-(container.offset().left))/(container.width());
            var ratio=((event.pageX)-(left))/(width);
